...
public class RoundRobin {
    ...
    //llega la lista de procesos listos y el tiempo
    ...
    public int listosARAM(Lista listos, Lista RAM){
        //valida si la ram esta vacia y no hay procesos en la ram
        if(RAM.esVacia()){
            listos.getInicio();      
            String proc_listo = listos.getInicio().getNombre();
            //Valida la cantidad de ram dispobible para seguir con el proceso
  ...
  //Lista de procesos, se visualiza los procesos que se encuentran en la lista
    ...
    //Cuando el proceso termina pasa a listos
